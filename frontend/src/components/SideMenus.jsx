...
export default function SideMenus({
  ...
  const analysisMenus = [
    ...
    (designation.includes("HOD QA") || designation.includes("Admin")) && {
      key: "qaAnalysis",
      label: "QA Analysis",
